          ...
          <CardContent className="flex flex-col items-center gap-4 py-10">
            ...
            {debugToken && (
              <div className="w-full rounded-lg bg-muted p-3 mt-2">
                <p className="text-xs text-muted-foreground mb-1">🔧 Token de teste:</p>
                <Link
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Recuperar senha de administrador</p>
        </div>

        <Card className="border-border/50 shadow-lg">
          <CardHeader className="pb-4">
            <CardTitle className="text-lg text-center text-foreground">Recuperar Senha</CardTitle>
