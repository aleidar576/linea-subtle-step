 ...
 */
async function createPayment({ amount, method, customer, shipping, items, card_token, installments, holder_document_number, loja_id }) {
  // Validações básicas
      ...
      paymentPayload = {
        ...
        payment_data: {
          credit_card: {
            ...
            holder_document_number: String(holder_document_number || document_number || '').replace(/\D/g, ''),
